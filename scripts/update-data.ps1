<#
  ...
  filter and year-range slider, day-by-day, and applies light smoothing —
  see public/app.js. This script only fetches and shapes the raw per-year
  data; it does not pre-aggregate a composite.
